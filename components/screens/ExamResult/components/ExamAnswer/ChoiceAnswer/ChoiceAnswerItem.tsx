...
const ChoiceAnswerItem = (
  { index }: ChoiceAnswerItemProps // Destructure the index prop
) => {
  return (
      ...
      <View style={ChoiceAnswerStyles.choiceAnswerItemQuestionBox}>
        <Text style={ChoiceAnswerStyles.choiceAnswerItemQuestion}>
          ...
          <Text style={ChoiceAnswerStyles.choiceAnswerItemQuestionText}>
            What is your name What is your name What is your name What is your
            name What is your name What is your name What is your name?
          </Text>
        </Text>
      </View>
      <View style={ChoiceAnswerStyles.choiceAnswerItemAnswerBox}>
        <RadioCustom
          title="abcd abd kja ia ia aj idj as io iud jaoi joia oiaj jhua oid ioa jud pap cv ji cv nad"
          checked
        />
